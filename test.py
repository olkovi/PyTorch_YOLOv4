...
def list_to_txt(list_, name='detections'):
            ...
            if nl:
                ...
                for cls in torch.unique(tcls_tensor):
                    ...
                    if pi.shape[0]:
                        ...
                        # ious - все обнаружения на одном изображении (возможно несколько ложных)
                        if all(ious < 0.6):
                            z01.append(paths[si])
                        ...
                        for j in (ious > iouv[0]).nonzero(as_tuple=False):
                            ...
                            if d not in detected:
                                ...
                                if ious[j] < 0.6 and ious[j] > 0.5:
                                    z05_07.append(paths[si])
                                if len(detected) == nl:  # all targets already located in image
                                    break
                        # for k in (ious < iouv[0]).nonzero(as_tuple=False):
                        #     if d not in detected:
                        #         detected.append(d)
                        #         if ious[k] == 0:
                        #             z00.append(paths[si])
                        #         else:
                        #             z01.append(paths[si])
            list_to_txt(z00, 'zero_accuracy.txt')
            list_to_txt(z01, 'low_accuracy.txt')
            list_to_txt(z05_07, 'z05_07.txt')

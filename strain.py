        ...
        if rank in [-1, 0]:
            ...
            if not opt.notest or final_epoch:  # Calculate mAP
                results, maps, times = test.test(opt.data,
                                                 ...
                                                 imgsz=imgsz_test,
                                                 save_json=True,#final_epoch, #and opt.data.endswith(os.sep + 'speed.yaml'),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default="weights/yolov4.weights", help='initial weights path') #'weights/yolov4.weights' False
    parser.add_argument('--cfg', type=str, default='cfg/yolov4_large_size_variation.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/speed.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='', help='hyperparameters path, i.e. data/hyp.scratch.yaml')
    parser.add_argument('--epochs', type=int, default=50)
    parser.add_argument('--batch-size', type=int, default=6, help='total batch size for all GPUs') #4 3070
